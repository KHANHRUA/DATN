# USAGE
# python recognize_faces_image.py --encodings encodings.pickle --D:\face\Face-Recognition-with-OpenCV-Python-DL\test_images\1.png
...
boxes = face_recognition.face_locations(rgb, 1, model=args["detection_method"])
...
for encoding in encodings:
    ...
    names.append(name)
     # In ID khuôn mặt vào terminal
    print(f"[INFO] Detected ID: {name}")
